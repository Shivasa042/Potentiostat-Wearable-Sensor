...
/* Common configurations for all kinds of Application. */
  int32_t bParaChanged;        /* Indicate to generate sequence again. It's auto cleared by AppBIAInit */
...
/* Application related parameters */ 
  ...
  int32_t HanWinEn;            /* Enable Hanning window */
...
/* Private variables for internal usage */
  ...
  int32_t IMPInited;                       /* If the program run firstly, generated sequence commands */
  SEQInfo_Type InitSeqInfo;
  SEQInfo_Type MeasureSeqInfo;
  int32_t StopRequired;          /* After FIFO is ready, stop the measurement sequence */
