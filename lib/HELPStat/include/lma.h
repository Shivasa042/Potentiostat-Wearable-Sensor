//=================================================================================================================
// This library is largely dependent on a modified version of Bolder Flight Systems' Eigen port for MPUs. This
// modified library adds nonlinear optimization and Levenberg-Marquardt algorithm implementation:
...
// for the equivalent Randels cell for electrochemical impedence spectroscopy. The code for parameter optimization
...
//=================================================================================================================
// calculate_Rct
// Description: Given real and imaginary impedance data, this function calculates and returns the optimal Rct value
...
// * std::vector<float> r_data - Vector of real impedance data in ohms
// * std::vector<float> i_data - Vector of imaginary impedance data in ohms
// Output:
...
//=================================================================================================================
// calculate_Rs
// Description: Given real and imaginary impedance data, this function calculates and returns the optimal Rs value
